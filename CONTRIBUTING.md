...
6. **Testler:** Her yeni betik için `testler/` altında test yazın (kapsam bekçisi testi eksik betiği yakalar). Örnek projeleri testlerde doğrudan değiştirmeyin; `roman`/`oyku` fikstürleri geçici kopya verir.
...
Claude Code yüklüyse eklenti ve SKILL.md ön bilgilerini ayrıca `claude plugin validate .` ile doğrulayabilirsiniz (Claude Code 2.1.233 ve sonrası).
