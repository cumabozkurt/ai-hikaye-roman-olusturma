...
GORSELLER = [
    ...
    ("terminal-kitaptik.svg", "Kitaptik yayın paketi",
     "python3 betikler/kitaptik_hazirla.py paket --proje saatcinin-kizi",
     ["skills/kitaptik-yayimla/betikler/kitaptik_hazirla.py", "paket", "--proje", "saatcinin-kizi"], True),
