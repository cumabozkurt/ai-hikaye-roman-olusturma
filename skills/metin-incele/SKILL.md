...
metadata: {"kaynak": "https://github.com/cumabozkurt/ai-hikaye-roman-olusturma", "surum": "1.0.0", "ust-kaynak": "oh-story-claudecode/story-review"}
---
...
5. **Öncelik listesi:** en çok etki edecek 3–5 düzeltme, her biri "sorun → neden önemli → nasıl" biçiminde.
6. **Yayın yolu notu (istenirse):** Wattpad için ilk bölüm kancası ve bölüm uzunluğu; yayınevi için ilk 30 sayfanın gücü ve dosya hazırlığı (`/yayinevi-dosyasi`).
